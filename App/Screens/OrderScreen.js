                        ...
                        <View style={[{ backgroundColor: '#ffffff', padding: '3%', }, styles.borderShadowHeader]}>
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ flex: 0.3, alignItems: 'flex-end' }}>
                                    <View style={{ flexDirection: 'row' }}>
                                        <TouchableOpacity>
                                            <Icon name={'plus'} size={RFValue(30)} color={'#0077ae'} />
                                        </TouchableOpacity>
                                        <TouchableOpacity>
                                            <Icon name={'search'} size={RFValue(30)} color={'#0077ae'} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
                    ...
                    <View style={{ flex: 3.5, borderRightColor: '#f5f6f8', borderRightWidth: 3, paddingBottom: '5%' }}>
                        <ScrollView>
                            <View style={{ padding: 10 }} >
                                <Text style={{ color: '#a8adb1', fontSize: 18 }}>{'Today'}</Text>
                            </View>
                            <TouchableOpacity style={[styles.drawerMenuItem.itemBtn, styles.orderSidebarView]}>
                                ...
                                <View style={[styles.drawerMenuItem.itemBtn.view, styles.orderSidebarView.btnView]}>
                                    ...
                                    <View>
                                        <Text style={{ color: '#f79645', fontSize: 16, fontFamily: 'OpenSans-Regular' }}>{'Refunded'}</Text>
                                    </View>
                                </View>
                            ...
                            <View style={{ padding: 10 }} >
                                <Text style={{ color: '#a8adb1', fontSize: 18 }}>{'Yesterday'}</Text>
                            </View>
                            <TouchableOpacity style={[styles.drawerMenuItem.itemBtn, styles.orderSidebarView]}>
                                {/* <TouchableOpacity> */}
                                <View style={[styles.drawerMenuItem.itemBtn.view, styles.orderSidebarView.btnView]}>
